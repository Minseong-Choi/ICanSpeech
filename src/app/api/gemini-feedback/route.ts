...
export async function POST(request: Request) {
  ...
  try {
    ...
    const prompt = `${transcript}
      위 STT 텍스트는 제가 진행한 발표연습 혹은 면접연습의 스크립트입니다. 먼저 위 발표가 발표연습인지, 면접 연습인지를 구분 한 후, 이 스크립트를 바탕으로 다음 각 항목에 대해 구체적이고 건설적인 피드백과 개선 조언을 제공해 주세요.
      답변의 첫번째 문장은 이 발표에 대한 점수(100점 만점) 이후 사설없이 즉시 각 항목에 대하여 피드백만 해주세요. 각 항목에 대한 피드백은 2-3문장 정도로 간결하게 작성해 주세요.
